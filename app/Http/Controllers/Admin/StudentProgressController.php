...
class StudentProgressController extends Controller
{
    ...
    public function show($student)
    {
        ...
        return view('admin.students.progress.show', compact('student', 'course', 'student_id', 'overview', 'noOfOverviewFiles', 'overviewFiles', 'studentAccomplish', 'studentActivitiesAccomplish', 'noOfAccomplishActivityByModule', 'studentAccomplishExam', 'accomplishExamByModule', 'canTakeExam', 'canDownloadCertificate'));
    }
}
